Pahadicoin Core version *0.15.1* is now available from:

  <https://download.pahadicoin.org/pahadicoin-0.15.1/>
...
A number of changes to the way Pahadicoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 milliPHC per kB (0.00001 PHC). This is to prepare for dropping the minimum transaction fee to 0.1 milliPHC per kB (0.0001 PHC) in the next release.
