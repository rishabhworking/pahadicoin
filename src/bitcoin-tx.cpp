...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pahadicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pahadicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pahadicoin transaction") + "\n" +
              "  pahadicoin-tx [options] -create [commands]   " + _("Create hex-encoded pahadicoin transaction") + "\n" +
              "\n";
