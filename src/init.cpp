...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pahadicoin-project/pahadicoin>";
    const std::string URL_WEBSITE = "<https://pahadicoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Pahadicoin version %s\n", FormatFullVersion());
}
